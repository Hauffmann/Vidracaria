...
namespace Vidracaria.Controllers
{
    public class EnderecoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Logradouro,Numero,Bairro,Cep,Cidade,Estado,Pais,Referencia,Extra1,Extra2,Extra3")] Endereco endereco)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Logradouro,Numero,Bairro,Cep,Cidade,Estado,Pais,Referencia,Extra1,Extra2,Extra3")] Endereco endereco)
        {
            if (ModelState.IsValid)
            {
